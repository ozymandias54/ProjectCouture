 ...
 * @author fofana
 */
public class Couturie extends javax.swing.JFrame {
public Utilisateur user=new Utilisateur();
    /**
     * Creates new form Couturie
     */
    public Couturie() {
        initComponents();
        bare.initJFram(this);
   ...
   private void deconnect(){
      ...
      private void execute() {
        ...
        addMenutitre(autre);addMenu(menuClient,menuDeconnect);
    ...
    private void initComponents() {
        ...
        panelMenuLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelMenuLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scroll, javax.swing.GroupLayout.DEFAULT_SIZE, 458, Short.MAX_VALUE))
        );
        ...
        jLabel3.setText("<html><body><u>Journal</u></body></html>");
        ...
        carte4.setBackground(new java.awt.Color(51, 51, 255));

        carte5.setBackground(new java.awt.Color(153, 0, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    .addGap(227, 227, 227)
                    .addComponent(body, javax.swing.GroupLayout.PREFERRED_SIZE, 842, Short.MAX_VALUE)))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    .addGap(63, 63, 63)
                    .addComponent(body, javax.swing.GroupLayout.PREFERRED_SIZE, 494, Short.MAX_VALUE)))
        );
 ...
 new FrameStat().statistiquaCaisseEntrée(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Couturie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
private void listeCarte(){
    ...
    carte4.setData("Depot total", ""+cmd.size());
    ...
    int c=fini+retiré;
    carte5.setData("Commande en cours", ""+encours);
    carte6.setData("Commande fini", ""+c);
  }
}
